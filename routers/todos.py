import sys
sys.path.append("..") #handles files in parent directory
...
async def read_all_by_user(request:Request, db: Session = Depends(get_db)):
    ...
    todos = db.query(models.Todos).filter(models.Todos.owner_id == user.get("id")).all() #hardcoded owner id until we implement authentication
    return templates.TemplateResponse('home.html', {'request': request, 'todos': todos, 'user': user}) #pass in jinja variables
